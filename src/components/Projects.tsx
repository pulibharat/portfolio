  ...
  return (
    <section id="projects" className="py-20 bg-white px-4 sm:px-6 lg:px-8">
      <div className="max-w-5xl mx-auto">
        <h2 className="text-3xl font-bold text-center text-slate-900 mb-4">My Projects</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
          {projects.map((project) => (
            <div
              key={project.id}
              className="bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-lg transition-shadow border border-slate-200 flex flex-col h-full"
            >
              {/* Project Image */}
              ...
              <div className="p-6 flex flex-col flex-1">
                ...
                <p className="text-slate-600 text-sm mb-4 leading-relaxed flex-1 font-medium">{project.description}</p>
                ...
                <div className="flex items-center gap-4 mt-auto pt-4 border-t border-slate-100">
                  {project.github && (
                    <a
                      ...
                      className="text-sm font-bold text-blue-700 hover:text-blue-900 flex items-center gap-1 transition-colors"
                    >
